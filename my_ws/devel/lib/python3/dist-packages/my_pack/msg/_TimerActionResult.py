...
"""autogenerated by genpy from my_pack/TimerActionResult.msg. Do not edit."""
import codecs
import sys
...
class TimerActionResult(genpy.Message):
  ...
  _type = "my_pack/TimerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_pack/TimerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_pack.msg.TimerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_pack.msg.TimerResult()
